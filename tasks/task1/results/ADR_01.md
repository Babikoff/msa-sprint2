...
Также обнаружено, что внутри монолита реализованна сервис ориентированная архитектура, которая проявляется в том, что сервис бронирования синхронно вызывает все остальные сервисы. Это накладывает ограничения на варинты дизайна логики данной системы в микросервисной архитектуре.
