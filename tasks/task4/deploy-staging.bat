...
REM  the STAGING values (ENABLE_FEATURE_X=true, replicaCount=1).
...
set "VALUES_FILE=./helm/booking-service/values-staging.yaml"
set "CONTAINER=test-booking-staging"
set "TEST_PORT=8081"
...
echo ============================================================
echo  Deploying %RELEASE_NAME% [STAGING]
...
echo.
echo [4/5] helm upgrade --install (staging values) ...
...
echo.
echo [OK] STAGING deployment (%ENABLE_FEATURE_X=true) successful.
